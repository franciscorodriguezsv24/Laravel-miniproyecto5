                   ...
                   <form class="p-5" action="{{route('cursos.update', $curso->id )}}" method="POST">
                    ...
                    <div class="mb-3 visually-hidden-focusable">
                       ...
                       <div class="mb-3">
                           ...
                           <input type="text" class="form-control" id="exampleInputPassword1" required value="{{ $curso->Maestro }}" name="Maestro">
                       </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">
                            Inscritos
                            </label>
                            <input type="text" class="form-control" id="exampleInputPassword1" required value="{{ $curso->Inscritos}}" name="Inscritos">
                        </div>
